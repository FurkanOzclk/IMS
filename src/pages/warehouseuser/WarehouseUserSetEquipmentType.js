...
const WarehouseUserSetEquipmentType = () => {
    ...
    const onSubmit = async () => {
        try {
            ...
            const { data } = await axiosInstance.post('/warehouseuser/equipmenttype', formData)
...
export default WarehouseUserSetEquipmentType;